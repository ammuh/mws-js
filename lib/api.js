...
var CONSTANTS = require('./credentials.json');
var mws = require('mws-js'),
    client = new mws.Client(CONSTANTS.accessKeyId, CONSTANTS.secretKey, CONSTANTS.sId, {});
...
submitInventoryChange(tsku, 20);
function submitInventoryChange(sku, stock){
